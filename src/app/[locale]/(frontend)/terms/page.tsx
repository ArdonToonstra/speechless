        ...
        <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <main className="flex-1 p-4 md:p-8 max-w-3xl mx-auto w-full">
                ...
                <div className="prose dark:prose-invert max-w-none">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-6">
                        By using Toast, you acknowledge and agree that your use of this application is entirely at your
                        own risk. We provide this service &quot;as is&quot; without any warranties, express or implied.
                    </p>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-6">
                        To the fullest extent permitted by applicable law, Toast and its creators shall not be liable
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-6">
                        You agree to use Toast only for lawful purposes. You are responsible for the content you create
                        and share within the application.
                    </p>
