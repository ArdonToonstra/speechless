...
export default async function Page() {
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col items-center text-foreground p-6 overflow-hidden">
            {/* Hero Section */}
            ...
            <div className="w-full max-w-5xl px-4 py-24 relative">
                ...
                <div className="relative flex flex-col md:flex-row items-center gap-8 md:gap-16 group">
                    <div className="md:w-1/2 text-left md:text-right md:pr-12 relative z-10 order-2 md:order-1">
                        ...
                        <h3 className="text-3xl font-serif font-bold mb-4 text-foreground">The Perfect Spot</h3>
                        <p className="text-muted-foreground text-lg leading-relaxed">
                            A great speech needs a great stage. When the speech is as a present and the receiver don't know. We will help you find the perfect spot.
                        </p>
                    </div>
                    ...
                    <div className="md:w-1/2 w-full pl-12 md:pl-0 order-1 md:order-2">
                        <div className="bg-card border border-border/50 rounded-xl shadow-xl overflow-hidden max-w-sm mx-auto md:mx-0">
                            ...
                            <div className="h-40 bg-muted relative">
                                ...
                                <div className="absolute bottom-3 left-3 text-white font-bold text-lg">The Historic Library</div>
